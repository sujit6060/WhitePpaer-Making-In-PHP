...
if (isset($_POST['sub'])) {
  ...
  $execute = mysqli_query($con, "INSERT INTO `landing`(`title`, `image`, `des`, `file`, `id1` ,`butt`,`logo`,`cat` ) VALUES ('$title','$image','$des','$file', '$id1', '$butt', '$logo', '$cat')");
  if ($execute) {
...
<body style="background: url(upload/tt.jpg)">
      ...
      <form id="form-wrapper" style="max-width:600px;margin:auto;color:white; border-style: solid; padding-right: 30px;padding-left: 30px;padding-top: 30px;padding-bottom: 30px; " class="form-group" action="" method="POST" enctype="multipart/form-data">
            <div class="form-group" >
              <h3 style="text-align: center;color: white; font-size:40px;">Direct Downloading</h3>
              <br>
